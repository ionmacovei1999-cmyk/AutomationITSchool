...
public class FramesTestV2 extends TestBasePage {


//    String text1 = "This is a sample page";
//    String text2 = "This is a sample page";

    @Test
    public void metodaTest(){

        String veriffyText1 = "This is a sample page";
        String veriffyText2 = "This is a sample page";
...
//        elementsList.get(2).click();
        ...
        FramesTestPage framesPage = new FramesTestPage(getDriver());
//        framesPage.frame1Text();
//        framesPage.frame2Text();
...
//        System.out.println("Textul din primul iframe este: " + iframeText2.getText());
        ...
        framesPage.verifyFrameText(veriffyText1, veriffyText2);
